    ...
    <form className="flex flex-col px-20 border" action={addTeacher}>
            ...
            <div className="border">
                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                    ...
                    <input type="text"  className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none" name="name" />
                </span>
                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                    <label className="text-sm font-medium">Birthday</label>
                    <input type="text" className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none" name="DOB" />
                </span>
                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                ...
                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                    ...
                    <input type="text"  className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none " name="address" />
                </span>

                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                    <label className="text-sm font-medium">Phone</label>
                    <input type="text" className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none " name="phone" />
                </span>

                <span className="flex justify-center items-center border px-2 text-center gap-3 py-5">
                    <label className="text-sm font-medium">Email</label>
                    <input type="email"  className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none " name="email" />
                </span>

                <span className="flex justify-center items-center border text-center gap-3 py-5">
                    <label className="text-sm font-medium">Password</label>
                    <input type="password" className="bg-primary text-black border rounded-md px-3 w-96 my-1 h-10 outline-none" name="password" />
                </span>
